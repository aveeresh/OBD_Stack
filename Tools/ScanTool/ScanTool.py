...
#PID $04
    ...
    # PID configuration: { PID: (Raw QLineEdit name, Physical QLineEdit name, num_bytes, offset, factor) }
        ...
        pid_config = {
            0x04: ("lineEdit_RawVal_Mode_01_PID_04", "lineEdit_PhyVal_Mode_01_PID_04", 1, 0, 2.55),
            0x05: ("lineEdit_RawVal_Mode_01_PID_05", "lineEdit_PhyVal_Mode_01_PID_05", 1, -40, 1),
            0x0C: ("lineEdit_RawVal_Mode_01_PID_0C", "lineEdit_PhyVal_Mode_01_PID_0C", 2, 0, 4),  # RPM = ((A*256)+B)/4
            0x22: ("lineEdit_RawVal_Mode_01_PID_22", "lineEdit_PhyVal_Mode_01_PID_22", 2, 0, 12.65),
            0x2C: ("lineEdit_RawVal_Mode_01_PID_2C", "lineEdit_PhyVal_Mode_01_PID_2C", 1, 0, 2.55),  # example
            0x31: ("lineEdit_RawVal_Mode_01_PID_31", "lineEdit_PhyVal_Mode_01_PID_31", 2, 0, 1),
        }
    ...
    def ProcessMode_09_Request(self):
        ...
        # PID configuration: { PID: (Raw QLineEdit name, Physical QLineEdit name, Description) }
        pid_config = {
            0x01: ("lineEdit_RawVal_Mode_09_PID_01", "lineEdit_PhyVal_Mode_09_PID_01", "VIN Message Count"),
            0x02: ("lineEdit_RawVal_Mode_09_PID_02", "lineEdit_PhyVal_Mode_09_PID_02", "Vehicle Identification Number (VIN)"),
            0x04: ("lineEdit_RawVal_Mode_09_PID_04", "lineEdit_PhyVal_Mode_09_PID_04", "Calibration ID")
        }

        for pid, (raw_name, phy_name, description) in pid_config.items():
            # Send Mode 09 request
